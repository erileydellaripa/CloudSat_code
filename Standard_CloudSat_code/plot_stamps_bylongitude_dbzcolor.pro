pro plot_stamps_bylongitude_dbzcolor, FILENAMES = filenames, meanlons = meanlons, nlons = nlons, $
                                      NAME = name
...
starting_lon = 50.
meanlons = (meanlons * 111.) - (starting_lon*111.)
...
;;;relative position in x
   centerpt = (max(xcloud) + min(xcloud))/2.
